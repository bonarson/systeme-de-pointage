...
public class Chauffeur extends Employe {
    ...
    public Chauffeur(String nom, String prenom, String numeroMatricule, Date dateDembauche, Date dateDeFinDecontrat, float montantDuSalaire, Categorie categorie) {
